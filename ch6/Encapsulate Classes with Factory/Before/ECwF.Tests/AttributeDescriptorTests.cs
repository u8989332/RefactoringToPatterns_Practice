namespace ECwF.Tests
{
    public class AttributeDescriptorTests
    {
        ...
        public void TestAllDescriptor()
        {
            ...
            result.Add(new DefaultDescriptor("remoteId", GetType(), typeof(int)));
            result.Add(new DefaultDescriptor("createdDate", GetType(), typeof(DateTime)));
            result.Add(new ReferenceDescriptor("createdBy", GetType(), typeof(User), typeof(RemoteUser)));
            result.Add(new BooleanDescriptor("isAdmin", GetType()));
